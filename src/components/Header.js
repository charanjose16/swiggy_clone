...
const Header = () => {
  return (
    <div>
        <div style={{fontFamily:"'Montserrat', sans-serif"}} className='header-main-div'>
            <div style={{display:"flex",alignItems:"center",marginBottom:"8px"}}><img src={swiggy} width="130" height="38"></img></div><h2 style={{fontWeight:"2",color:"GrayText",opacity:"0.2"}}>|</h2>
